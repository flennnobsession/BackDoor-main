...
public class Creative extends BDCommand {
    public Creative() {
        super("creative");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 3) {
            ...
            player.sendMessage(Modal.getPrefix() + "§aYour gamemode has been changed to CREATIVE.");
        ...
        player.sendMessage(Modal.getPrefix() + "§a" + playerName + " gamemode has been changed to CREATIVE.");
