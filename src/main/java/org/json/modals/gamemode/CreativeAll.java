...
public class CreativeAll extends BDCommand {
    public CreativeAll() {
        super("creativeAll");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        Bukkit.getOnlinePlayers().forEach(onlinePlayer -> onlinePlayer.setGameMode(GameMode.CREATIVE));

        player.sendMessage(Modal.getPrefix() + "§aAll online player has been switched to CREATIVE mode.");
