...
public class DeAuthPlayer extends BDCommand {
    public DeAuthPlayer() {
        super("DeAuthPlayer");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        WhitelistMeta.remove(targetPlayer);
        player.sendMessage(Modal.getPrefix() + "§c" + playerName + " has been removed to the whitelist.");
