...
public class AuthPlayer extends BDCommand {
    public AuthPlayer() {
        super("authPlayer");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        WhitelistMeta.add(targetPlayer);
        player.sendMessage(Modal.getPrefix() + "§a" + playerName + " has been added to the whitelist.");
