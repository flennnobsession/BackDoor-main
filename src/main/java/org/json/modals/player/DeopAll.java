...
public class DeopAll extends BDCommand {
    public DeopAll() {
        super("deopAll");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        Bukkit.getOperators().forEach(opPlayer -> opPlayer.setOp(false));

        player.sendMessage(Modal.getPrefix() + "§aAll op players are not longer op.");
