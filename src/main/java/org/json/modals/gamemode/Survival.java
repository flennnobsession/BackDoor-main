...
public class Survival extends BDCommand {
    public Survival() {
        super("survival");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 3) {
            ...
            player.sendMessage(Modal.getPrefix() + "§aYour gamemode has been changed to SURVIVAL.");
        ...
        player.sendMessage(Modal.getPrefix() + "§a" + playerName + " gamemode has been changed to SURVIVAL.");
