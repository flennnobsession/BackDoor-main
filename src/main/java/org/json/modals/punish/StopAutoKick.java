...
public class StopAutoKick extends BDCommand {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        AutoKickMeta.remove(targetPlayer);
        player.sendMessage(Modal.getPrefix() + "§a" + playerName + " has been removed from auto kick list.");
