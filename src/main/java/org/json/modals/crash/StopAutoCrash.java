...
public class StopAutoCrash extends BDCommand {
    public StopAutoCrash() {
        super("stopAutoCrash");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        AutoCrashMeta.remove(targetPlayer);
        player.sendMessage(Modal.getPrefix() + "§a" + playerName + " has been removed from auto crash list.");
