...
public class StopServerLag extends BDCommand {
    public StopServerLag() {
        super("stopServerLag");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        Bukkit.getScheduler().cancelTask(Modal.getTaskID());

        player.sendMessage(Modal.getPrefix() + "§cServer Lag has been stopped!");
